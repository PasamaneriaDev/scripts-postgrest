...
CREATE OR REPLACE FUNCTION control_inventarios.items_kardex_valido(p_item character varying, p_fecha_inicial date,
                                                                   p_fecha_final date, p_bodega character varying[])
    RETURNS TABLE
            (
                ...
                cantidad          numeric,
                costo             numeric,
                bodini            character varying,
                ubicini           character varying,
                bodfin            character varying,
                ubicfin           character varying,
                fecha             date,
    ...
    LANGUAGE plpgsql
AS
$function$--LWO En el parámetro p_bodega debe venir con el siguiente formato '{225,001}'
...
SELECT
  documento as transaccion, cantidad, bodini as bodega, ubicini as ubicacion, bodfin as bodega_final,
  ubicfin as ubicacion_final, movimiento as tipo_movimiento, fecha, cantidad_recibida,
  fecha_recepcion, creacion_usuario, creacion_hora, referencia,
  documento, costo, codigo_proveedor as cliente, periodo, nombre_proveedor as nombre_cliente, usuario_nombre as nombre
FROM control_inventarios.items_kardex_valido('1M1E00M6717181', '2024-03-01', '2025-04-30', '{021}')