...
CREATE OR REPLACE FUNCTION puntos_venta.reporte_ventas_netas_almacen_detallado(p_periodo varchar, p_bodegas varchar, p_monto_minimo numeric)
    RETURNS TABLE
            (
                periodo           varchar,
...
BEGIN
    RETURN QUERY
        ...
        GROUP BY ib.bodega, ib.descripcion, fd.fecha
        ORDER BY ib.bodega, fd.fecha;
    ...
    -- GROUP BY x1.bodega, x1.descripcion, fd.fecha
