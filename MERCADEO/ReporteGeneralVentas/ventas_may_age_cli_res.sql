...
CREATE OR REPLACE FUNCTION cuentas_cobrar.reporte_general_ventas_may_age_cli_res(p_params text)
    RETURNS table
            (
                vendedor        varchar,
...
SELECT '2025-06-30' AS p_fecha_inicial,
       ...
       *
FROM cuentas_cobrar.reporte_general_ventas_may_age_cli_res('{
