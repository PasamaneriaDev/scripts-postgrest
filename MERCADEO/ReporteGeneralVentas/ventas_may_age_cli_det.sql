...
CREATE OR REPLACE FUNCTION cuentas_cobrar.reporte_general_ventas_may_age_cli_det(p_params text)
    RETURNS table
            (
                vendedor        varchar,
...
SELECT *
FROM cuentas_cobrar.reporte_general_ventas_may_age_cli_det('{
