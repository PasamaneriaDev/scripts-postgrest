-- drop function cuentas_cobrar.reporte_general_ventas_may_cli_det(p_params text);

CREATE OR REPLACE FUNCTION cuentas_cobrar.reporte_general_ventas_may_cli_det(p_params text)
    RETURNS table
            (
                cliente         varchar,
...
SELECT *
    from cuentas_cobrar.reporte_general_ventas_may_cli_det('{
