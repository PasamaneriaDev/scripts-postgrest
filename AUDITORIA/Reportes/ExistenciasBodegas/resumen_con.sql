-- DROP FUNCTION auditoria.reporte_existencias_bodega_resumen_con(varchar, varchar, varchar, varchar, bool, bool, bool, bool, varchar, varchar, varchar);

CREATE OR REPLACE FUNCTION auditoria.reporte_existencias_bodega_resumen_con(p_bodegas character varying,
