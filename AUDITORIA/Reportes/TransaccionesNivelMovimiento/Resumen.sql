...
CREATE OR REPLACE FUNCTION auditoria.reporte_transacciones_nivel_movimiento_resumen(p_periodo_ini varchar,
...
BEGIN
    ...
    */
    ...
    RETURN QUERY
        ...
        GROUP BY d.cuenta, cd.descripcion, t.tipo_movimiento, t.periodo, tipo_materia
        ORDER BY t.periodo, CASE WHEN p_orden = 'CUE' THEN d.cuenta ELSE cd.descripcion END;
END;
$function$
;
