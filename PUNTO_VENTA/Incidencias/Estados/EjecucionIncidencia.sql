...
CREATE OR REPLACE FUNCTION puntos_venta.incidencias_cambiar_estado_enejecucion(p_numero_incidencia integer,
...
BEGIN
    ...
    VALUES (p_numero_incidencia, 'EN EJECUCION', p_usuario, CURRENT_TIMESTAMP);
